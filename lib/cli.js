...
cli.responders.get = function(str) {
  ...
  if (str == "*") {
    console.log("\x1b[95m%s\x1b[0m", JSON.stringify(data.admin, null, 2));
  } else {
    if (data.admin.hasOwnProperty(str)) {
      console.log("\x1b[95m%s\x1b[0m", `${data.admin[str]}`);
    } else {
